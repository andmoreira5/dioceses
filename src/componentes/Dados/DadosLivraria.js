module.exports.data = [
    {
        ...
        content:[
            {
                nome:'Acolhida e pastoreio no Grupo de Oração',
    ...
    {
        titulo:'Ministério de Comunicação Social',
        content:[
            {
                nome:'Ministério de Comunicação Social',
                detalhes:'Apostila formativa para comunicadores'
            },
            {
                nome:'RCC responde 17 - Ministerio de Comunicação Social',
                detalhes:'Perguntas e respostas sobre o Ministério'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        content:[
            {
                nome:'Orientações para o serviço com os jovens no Grupo de Oração',
                detalhes:''
            }
        ]
    },
    {
        titulo:'Ministério de Música e Artes',
        content:[
            {
                nome:'Formação para o Ministério de Música e Artes 01',
                detalhes:'Material formativo para artistas'
            },
            {
                nome:'Formação para o Ministério de Música e Artes 02',
                detalhes:'Material formativo para artistas'
            }
        ]
    },
    {
        titulo:'Ministério de Promoção Humana',
        content:[
            {
                nome:'RCC responde 8 - Ministério de Promoção Humana',
                detalhes:'Tira-dúvidas sobre o Ministério'
            }
        ]
    }
]
